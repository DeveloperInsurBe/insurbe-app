...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-full border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 xl:sticky xl:top-0 xl:h-screen xl:w-[280px] xl:border-b-0 xl:border-r">
      ...
      <nav className="px-3 pb-3 sm:px-4 sm:pb-4 xl:px-5">
        ...
        {menu.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`shrink-0 whitespace-nowrap flex items-center gap-2 rounded-full px-3 py-2.5 text-xs font-semibold transition-all sm:gap-3 sm:px-4 sm:py-3 sm:text-sm xl:w-full xl:rounded-xl ${
                active
      ...
      <div className="border-t border-gray-100 px-3 py-3 sm:px-4 sm:py-4 xl:px-5">
        <button
