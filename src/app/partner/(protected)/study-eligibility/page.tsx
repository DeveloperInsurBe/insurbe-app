...
export default function StudyEligibilityPage() {
  return (
    <div className="space-y-6 md:space-y-8">
      <div className="text-sm text-gray-500">
        Partner Portal / <span className="font-semibold text-black">Study Eligibility</span>
      </div>
      ...
      <div className="relative overflow-hidden rounded-[24px] md:rounded-[32px] border border-white/50 bg-gradient-to-br from-white via-[#faf7ff] to-[#f3e8ff] p-5 sm:p-6 md:p-8 shadow-[0_12px_40px_rgba(130,10,209,0.08)]">
        ...
        <div className="relative z-10 flex items-start gap-4">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#111827]">Study Eligibility</h1>
            <p className="mt-2 text-sm md:text-base text-[#667085] max-w-2xl">
              Eligibility workflow is under refinement to deliver a cleaner and faster experience on all screen sizes.
            </p>
          </div>
        </div>
      </div>
