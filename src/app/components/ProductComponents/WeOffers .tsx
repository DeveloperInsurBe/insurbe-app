  ...
  return (
    <section className="relative py-10 md:py-16 px-4 sm:px-8 overflow-hidden">
      ...
      <motion.div
        ...
        className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10"
      >
          ...
          return (
            ...
            >
              ...
              <motion.div
                ...
                className={`absolute top-4 right-4 bg-gradient-to-r ${plan.gradient} text-white px-3 py-1 rounded-full text-xs font-bold shadow-md flex items-center gap-1 z-10`}
              >
              ...
              <motion.div
                ...
                className={`relative w-16 h-16 rounded-2xl bg-gradient-to-br ${plan.gradient} flex items-center justify-center mb-6 shadow-lg group-hover:shadow-xl transition-shadow`}
              >
                <motion.div
                  animate={{
                    scale: [1, 1.2, 1],
                  ...
                  className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${plan.gradient} opacity-30 blur-md`}
                />
              ...
              <div className="relative z-10">
                <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-primary transition-all duration-300">
                  {plan.title}
                </h3>
              ...
              {/* Border Glow Effect */}
              <motion.div
                className={`absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-br ${plan.gradient}`}
